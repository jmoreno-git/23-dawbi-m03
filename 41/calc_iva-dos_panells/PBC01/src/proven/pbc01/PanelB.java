...
public class PanelB extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        setBorder(javax.swing.BorderFactory.createTitledBorder("Brut"));

        tf.setColumns(10);
        tf.setText("jTextField1");
        tf.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PanelB.this.actionPerformed(evt);
            }
        });

        lbl.setText("Preu amb  IVA");
    ...
    public void setValue(double value) {
        System.out.println("PanelB[value]="+value);
