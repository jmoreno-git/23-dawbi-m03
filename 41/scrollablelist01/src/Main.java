...
//        });
        ...
        model.addVetoableChangeListener("position", new ModelBeanConstraintChecker());
...
//            model.setData(50, "b50");
            System.out.println("* Setting position to 50");
            model.setPosition(50);
            System.out.println("After changing position to 50");
