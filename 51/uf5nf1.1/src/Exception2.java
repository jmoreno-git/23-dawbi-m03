...
public class Exception2 {
    ...
    public static void main(String[] args) {
        ...
        x = 10;
        y = 2;  //change this value to assess when exception is thrown
        try {
     ...
     * @throws ArithmeticException if b is zero (optional declaration as
     * AritmeticException is not required to be verified, it inherits from
     * RuntimeException)
     */
