...
public class Person {
    ...
    /* constructors */
    /**
     * Person() full initializer constructor
     *
    ...
    /**
     * Person() constructor without any initialization (default constructor)
     *
     * @param none
     * @return nothing
     */
    ...
    public String getNif()
        ...
        if (nif == null) {
            throw new PropertyNotInitializedException("the \"nif\" is not set");
        }
        if (!isNifValid()) {
            throw new InvalidValueException("Property \"nif\" has not a valid value");
        }
        return nif;
    }
     ...
     * @throws InvalidValueException if parameter value is not valid for
     * property 'nif'
     * @return nothing
     */
    public void setNif(String nif) throws InvalidValueException {
        if (!isAValidNif(nif)) {
            throw new InvalidValueException("invalid value for property \"nif\"");
        }
        this.nif = nif;
    }
    ...
    public String getName() throws PropertyNotInitializedException {
        if (name == null) {
            throw new PropertyNotInitializedException("the \"name\" is not set");
        }
        return name;
    }
    ...
    public void setName(String name) throws InvalidValueException {
        if (name == null) {
            throw new InvalidValueException("invalid value for property \"name\"");
        }
        this.name = name;
    }
    ...
    public void setAge(int age) throws InvalidValueException {
        if (age >= 0) {
            ...
            throw new InvalidValueException("invalid value for property \"age\"");
        }
    }

    /* methods */
    /**
     * isNifValid() checks if property 'nif' has a valid value
     *
     * @param none
     * @return true if nif is valid, false otherwise
     */
    public boolean isNifValid() {
        boolean flag = isAValidNif(nif);
        return flag;
    }

    /**
     * isAValidNif() checks if parameter 'nif' has a valid value for property
     * 'nif'
     *
    ...
    /**
     * toString() gives a String representations of this person
     *
     * @param none
    ...
    /**
     * equals() compares this person to another one two persons are equals if
